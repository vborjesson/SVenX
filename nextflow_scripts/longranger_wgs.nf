...
// Longranger wgs will generate bam and vcf files. If dry run; output-files are already generated, and the script will test if the workflow works. 
// Inputs are the path to longranger fastq-fils and ID. Output will be the new files generated by longranger with ID as basename. 
