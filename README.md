...
Why does not sample works? try to channel sample as well and map it.     

For later:
        Make bash script that will make separeate folders for each sample. 
        Change _bam and _vcf to .bam and .vcf
---
